...
* OpenAccess server, or your primary OnGuard server (in the RestMethod strings, or $appServer if you want)
* AppIDs within the headers for your environment/apps

You will also need the "sqlcmd" module installed for Powershell, which works with MS SQL DB Instances. 
If you run Oracle, this script won't work (it may be serviceable to convert, but it is untested!)
